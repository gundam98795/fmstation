        ...
        <main class="form-signin position-absolute top-50 start-50 translate-middle">
            <form method="POST" action="cust_form.php">
                <div class="form-floating">
                    <input type="text" name="code" class="form-control" id="floatingInput" placeholder="編號">
                ...
                <button class="w-90 btn btn-lg btn-info border border-dark border-1 m-1" type="submit" name="fix"><b>修正</b></button>
            </form>
        </main>
    </div>
